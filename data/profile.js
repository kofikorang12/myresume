const profileData = {
  ...
  about: {
    intro: `A Fullstack Software Engineer with 3 years of experience, specializing in building high-performance user interfaces and delivering seamless user experiences. Proficient in leading projects, migrating legacy systems, and creating reusable components to enhance efficiency and maintainability. Skilled in A/B testing, ensuring cross-platform compatibility, and implementing responsive design principles to deliver optimal experiences across devices. Effective mentor and collaborator, dedicated to continuous learning and driving innovation within the team.`,
    contact: {
      email: "jbaah69@gmail.com",
      phone: "+233-573942475",
      address: "GH",
    },
  },
  links: [
    {
      title: "LinkedIn",
      src: "https://www.linkedin.com/in/jeffrey-baah",
      iconClass: "fa-brands fa-linkedin-in",
    },
    {
      title: "Github",
      src: "https://github.com/kofikoran12",
  ...
  skills: [
    ...
    {
      title: "CI-CD",
      value: "CodePipeline, GitHub Actions",
    },
    {
